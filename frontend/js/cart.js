...
async function getCartSummary() {
    ...
    for (const cartItem of cartItems) {
        ...
        const quantity = cart.find(item => item.sizeOptionId === size_option_id).numberOfUnits;
...
function deleteFromCart(sizeOptionId, price) {
  ...
  function updateTotal() {
    ...
    const deliveryPrice = parseInt(document.getElementById('summary-delivery').innerText);
